...
class DiaMarket(SuperMarket):
    ...
    def get_products_from_markets(self) -> list[SupermarketProduct]:
        ...
        self.logger.info(f'******************[ INICIADO EL SCRAPING ]******************')
        ...
        for market_value in response.find_all('li'):
            try:
                ...
                new_product = SupermarketProduct(market_DIA,
                                                 product_name,
                                                 product_price)

                product_list.append(new_product)

                self.logger.info(f'* Se extrajeron correctamente el producto:'
                                 f' {new_product.__str__()}')
